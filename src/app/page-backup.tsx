...
const RiskAnalyzer = dynamic(() => import('../components/RiskAnalyzer'), {
  ssr: false,
  loading: () => <div style={{ height: '400px', background: 'rgba(255,255,255,0.05)', borderRadius: '24px' }} />
});

const NextFeatures = dynamic(() => import('../components/NextFeatures'), {
  ssr: false,
  loading: () => <div style={{ height: '400px', background: 'rgba(255,255,255,0.05)', borderRadius: '24px' }} />
});
      ...
      <header style={{
        ...
        <div style={{
          ...
          <nav style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
            {['Expert Lounge'].map(item => (
              <a key={item} href={item === 'Expert Lounge' ? '/expert-lounge' : `#${item.toLowerCase()}`} style={{
      ...
      <section style={{ 
        ...
        <div style={{
          ...
          {[
            ...
            { number: '<87ms', label: 'Response Time' }
          ].map((stat, i) => (
            <div key={i} style={{
          ...
          <div style={{
            ...
            {[
              { 
                ...
                desc: 'Generate optimized posts with our AI assistant',
                progress: 75,
                status: 'Q1 2025',
              ...
              { 
                ...
                desc: 'Analyze posts in 50+ languages',
                progress: 90,
                status: 'Dec 2024',
                phase: 'Beta Testing',
                color: '#10b981'
              ...
              { 
                ...
                desc: 'Manage social media safety for your entire team',
                progress: 30,
                status: 'Q2 2025',
                phase: 'Planning',
                color: '#f59e0b'
              ...
              { 
                ...
                desc: 'Real-time alerts for trending risky topics',
                progress: 60,
                status: 'Jan 2025',
                phase: 'In Development',
                color: '#8b5cf6'
              ...
              { 
                ...
                desc: 'Scan comments before replying',
                progress: 15,
                status: 'Q3 2025',
                phase: 'Research',
                color: '#ef4444'
              ...
              { 
                ...
                desc: 'Schedule safe posts in advance',
                progress: 50,
                status: 'Feb 2025',
                phase: 'In Development',
                color: '#3b82f6'
